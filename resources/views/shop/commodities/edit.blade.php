...
@section('content')
    ...
    <form action="{{ route('shop.commodities.update',$commodity->id) }}" method="POST">
        ...
        <div class="form-floating mb-3">
            <input name="name" type="text" class="form-control" id="name" placeholder="商品名稱" autocomplete="off" required value="{{ $commodity->name }}">
        ...
        <div class="form-floating">
            <textarea name="description" class="form-control" placeholder="商品描述" id="description" style="height: 300px">{{ $commodity->description }}</textarea>
